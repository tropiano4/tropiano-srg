...
END MODULE constant
 ...
 CONTAINS
	...
	SUBROUTINE DiagonalizationMethod_goto_SelfConsistency(diagonal, tolerance)
		...
		DOUBLE PRECISION :: accuracy, b, diff, factor, R2
		DOUBLE PRECISION :: Gauge, ShiftReal
		...
		WRITE(6,'("Oscillator length ..............: ",F6.3)') b
		WRITE(6,'("Atomic number A ................: ",i6)') A
		WRITE(6,'("Largest Number .................: ",E20.14)') HUGE(TestAccuracy)
		WRITE(6,'("Smallest Number ................: ",E20.14,/)') TINY(TestAccuracy)
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		CALL SymHartreeFockFieldProj_product(ekcm_field, DBLE(1.0 / A), field1)
		CALL SymHartreeFockFieldProj_product(ekcm_field, DBLE(0.0), field1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

		! Mean-field - Brink-Boker term. We contract a matrix element v_{abcd}(ta) of given isospin ta with a projected density
		...
		! Protons
		CALL SymVCph_get_Gamma(field1, diagonal%consistency%vCph, diagonal%consistency%density%field%rho, 0, 0, 0)
		! Neutrons (vanishes of course)
		CALL SymVCph_get_Gamma(field1, diagonal%consistency%vCph, diagonal%consistency%density%field%rho, 1, 1, 0)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		CALL SymHartreeFockFieldProj_product(vc_field, DBLE(0.0), field1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		...
		CALL SymGDDph_update(field1, diagonal%consistency%gDDph, diagonal%consistency%density%field%rho, Gauge)
                !@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                CALL SymHartreeFockFieldProj_product(gdd_field, DBLE(0.0), field1)
                !@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
			CALL SymHartreeFockFieldProj_product(ekcm_field, DBLE(1.0 / A), field1)
			CALL SymHartreeFockFieldProj_product(ekcm_field, DBLE(0.0), field2)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		ELSE
			CALL SymKineticEnergy2Body_get_Delta(field1, diagonal%consistency%vEkCMpp, diagonal%consistency%density%field%kap, 0, 0, 0)
			CALL SymKineticEnergy2Body_get_Delta(field1, diagonal%consistency%vEkCMpp, diagonal%consistency%density%field%kap, 1, 1, 0)
		...
		IF (HFOnly .EQ. 0) THEN
			...
			CALL SymVBBpp_get_Delta(field1, diagonal%consistency%vBBpp, diagonal%consistency%density%field%kap, 1, 1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                        CALL SymHartreeFockFieldProj_product(vbb_field,DBLE(1.0), field1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		ELSE
			CALL SymVBBpp_get_Delta(field1, diagonal%consistency%vBBpp, diagonal%consistency%density%field%kap, 0, 0)
			CALL SymHartreeFockFieldProj_product(vbb_field, DBLE(0.0), field1)
		END IF
		...
		IF (HFOnly .EQ. 0) THEN
			...
			CALL SymVCpp_get_Delta(field1, diagonal%consistency%vCpp, diagonal%consistency%density%field%kap, 1, 1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
			CALL SymHartreeFockFieldProj_product(vc_field, DBLE(0.0), field1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		ELSE
		...
		IF (HFOnly .EQ. 0) THEN
			...
			CALL SymVLSpp_get_Delta(field1, diagonal%consistency%vLSpp, diagonal%consistency%density%field%kap, 1, 1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
			CALL SymHartreeFockFieldProj_product(vls_field, DBLE(0.0), field1)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		ELSE
			CALL SymVLSpp_get_Delta(field1, diagonal%consistency%vLSpp, diagonal%consistency%density%field%kap, 0, 0)
			CALL SymHartreeFockFieldProj_product(vls_field, DBLE(0.0), field1)
	...
	FUNCTION DiagonalizationMethod_operator(diagonal)
		...
		DOUBLE PRECISION :: np, R2, b2, trace, Factor

		INTEGER :: a, d, dd, la, ja, i, jj, k, Isospin
		INTEGER :: u1, u2
	...
	SUBROUTINE DiagonalizationMethod_show_ParticleEnergies(diagonal, Gauge)
		...
		DOUBLE PRECISION :: b, spn, spp, e_cano, d_cano
		...
		DO ta = 0, 1
			...
			DO a = 0, 2*Lmax
				...
				DO i = 1, dim_cur
					...
					averageDelta(ta) = averageDelta(ta) - P(ta)%quantum(i, i) * D(ta)%value(i) * (1.0 - D(ta)%value(i))
					normDelta(ta) = normDelta(ta) + D(ta)%value(i) * (1.0 - D(ta)%value(i))
		...
		DO WHILE (SingleParticleE(1)%value(in(i)) .GE. -100.0 .AND. SingleParticleE(1)%value(in(i)) .LE. 40.0 .AND. i .LT. dim_mat(1))
			...
			END IF
                        ...
                        WRITE(*,'(I4,")",2X,A2,I2,"/2",3x,F10.8,F10.3,F8.3,3F8.3)') &
		...
		DO WHILE (SingleParticleE(0)%value(ip(i)) .GE. -100.0 .AND. SingleParticleE(0)%value(ip(i)) .LE. 40.0 .AND. i .LT. dim_mat(0))
			...
			ELSE
				WRITE(label,'(3x,I1,A1,I1,"/2")') Count(Lvalue, Jvalue), spectr(Lvalue), Jvalue
			END IF
                        WRITE(*,'(I4,")",2X,A2,I2,"/2",3X,F10.8,F10.3,F8.3,2F8.3)') &
	...
	SUBROUTINE DiagonalizationMethod_show_QuasiParticleEnergies(diagonal)
		...
		DOUBLE PRECISION :: sumvv, test, factor, x, Rwave, boscil
 ...
 1              	CONTINUE
	...
	SUBROUTINE DiagonalizationMethod_ProjectedEnergy(diagonal)
		...
		TYPE (SymGenDensityGaugeProj), DIMENSION(:), POINTER :: genden_gauge_real_n, genden_gauge_imag_n, &
		                                                        genden_gauge_real_p, genden_gauge_imag_p
		...
		CALL SymGenDensityProj_make_DensityGauge(diagonal%UV, genden_gauge_real_p, genden_gauge_imag_p, &
		                                         diagonal%consistency%density%nucleus, FactorProt, NGauge_p, 0)

                CALL DiagonalizationMethod_set_Isospin(diagonal, 1)
		CALL SymGenDensityProj_make_DensityGauge(diagonal%UV, genden_gauge_real_n, genden_gauge_imag_n, &
		...
		CALL SymGenDensityProj_make_DensityProj(genden_proj_real, genden_proj_imag, CoeffsXY, &
		                                        genden_gauge_real_p, genden_gauge_imag_p, diagonal%UV, &
							diagonal%consistency%density%nucleus, FactorProt, NGauge_p, 0)
		CALL SymGenDensityProj_make_DensityProj(genden_proj_real, genden_proj_imag, CoeffsXY, &
		                                        genden_gauge_real_n, genden_gauge_imag_n, diagonal%UV, &
							diagonal%consistency%density%nucleus, FactorNeut, NGauge_n, 1)
		...
		ProjectedEk = factor * (EkField * density_real%field%rho%p(0) + EkField * density_real%field%rho%p(1)) &
			    + factor * (EkField * density_imag%field%rho%p(0) + EkField * density_imag%field%rho%p(1))*CMPLX(0.0d0, 1.0d0)
		...
		ProjectedEkCM = (0.5d0 / A) * (P(0) + P(1))*CMPLX(1.0d0, 0.0d0)
		...
		ProjectedEkCM = ProjectedEkCM + (0.5d0 / A) * (P(0) + P(1))*CMPLX(0.0d0, 1.0d0)
		...
		ProjectedVBB_local = 0.5d0 * (P(0) + P(1))*CMPLX(1.0d0, 0.0d0)
		...
		ProjectedVBB_local = ProjectedVBB_local + 0.5d0 * (P(0) + P(1))*CMPLX(0.0d0, 1.0d0)
		...
		ProjectedVBB_exch = 0.5d0 * (P(0) + P(1))*CMPLX(1.0d0, 0.0d0)
		...
		ProjectedVBB_exch = ProjectedVBB_exch + 0.5d0 * (P(0) + P(1))*CMPLX(0.0d0, 1.0d0)
		...
		ProjectedVC_local = 0.5d0 * (P(0) + P(1))*CMPLX(1.0d0, 0.0d0)
		...
		ProjectedVC_local = ProjectedVC_local + 0.5d0 * (P(0) + P(1))*CMPLX(0.0d0, 1.0d0)
		...
		ProjectedVC_exch = 0.5d0 * (P(0) + P(1))*CMPLX(1.0d0, 0.0d0)
		...
		ProjectedVC_exch = ProjectedVC_exch + 0.5d0 * (P(0) + P(1))*CMPLX(0.0d0, 1.0d0)
		...
		ProjectedVLS = 0.5d0 * (P(0) + P(1))*CMPLX(1.0d0, 0.0d0)
		...
		ProjectedVLS = ProjectedVLS + 0.5d0 * (P(0) + P(1))*CMPLX(0.0d0, 1.0d0)
		...
		ProjectedDD = SymGDDph_get_edd(gDDph)*CMPLX(1.0d0, 0.0d0)
		...
		!ProjectedDD = ProjectedDD + SymGDDph_get_edd(gDDph)*CMPLX(0.0d0, 1.0d0)
		...
		DO IndexGauge = 1, NGauge_p
			...
			ProjectedEkCM = ProjectedEkCM + (0.5d0 / A) * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedEkCM = ProjectedEkCM + (0.5d0 / A) * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVBB_local = ProjectedVBB_local + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVBB_local = ProjectedVBB_local + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVBB_exch = ProjectedVBB_exch + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVBB_exch = ProjectedVBB_exch + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVC_local = ProjectedVC_local + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVC_local = ProjectedVC_local + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVC_exch = ProjectedVC_exch + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVC_exch = ProjectedVC_exch + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVLS = ProjectedVLS + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVLS = ProjectedVLS + 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			!density01 = diagonal%consistency%density
                        ...
                        CALL SymKineticEnergy2Body_get_Delta(HF_Delta, diagonal%consistency%vEkCMpp, &
                                                                       density10_real%field%kap, 0, 0, ProjectionOn)

                        P(0) =  SymHartreeFockFieldProj_product_iso(density01_real%field%kap, HF_Delta, 0)

                        ProjectedEkCM_Pair = ProjectedEkCM_Pair &
                                           - ( 0.5d0/A ) * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)

                        CALL SymKineticEnergy2Body_get_Delta(HF_Delta, diagonal%consistency%vEkCMpp, &
                                                                       density10_imag%field%kap, 0, 0, ProjectionOn)
                        ...
                        ProjectedEkCM_Pair = ProjectedEkCM_Pair  &
                                           - ( 0.5d0/A ) * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVBB_Pair = ProjectedVBB_Pair - 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVBB_Pair = ProjectedVBB_Pair - 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVC_Pair = ProjectedVC_Pair - 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVC_Pair = ProjectedVC_Pair - 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
			...
			ProjectedVLS_Pair = ProjectedVLS_Pair - 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(P(0), 0)
			...
			ProjectedVLS_Pair = ProjectedVLS_Pair - 0.5d0 * CoeffsXY%y_l(0)%index(IndexGauge) * CMPLX(0.0d0, P(0))
		...
		DO IndexGauge = 1, NGauge_n
			...
			! Two-body kinetic energy (center of mass motion)
			CALL SymKineticEnergy2Body_get_Gamma(HF_Gamma_Diff, diagonal%consistency%vEkCMph, &
			                                                    density10_real%field%rho, 1, 1, ProjectionOn)

			P(1) = SymHartreeFockFieldProj_product_iso(density10_real%field%rho, HF_Gamma_Diff, 1)

			ProjectedEkCM = ProjectedEkCM + (0.5d0 / A) * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)

			CALL SymKineticEnergy2Body_get_Gamma(HF_Gamma_Diff, diagonal%consistency%vEkCMph,  &
			                                                    density10_imag%field%rho, 1, 1, ProjectionOn)
			...
			ProjectedEkCM = ProjectedEkCM + (0.5d0 / A) * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			! Brink-Boeker direct term
			CALL SymVBBph_get_LocalGamma(HF_Gamma_Diff, diagonal%consistency%vBBph, &
			                                            density10_real%field%rho, 1, 1, ProjectionOn)

			P(1) = SymHartreeFockFieldProj_product_iso(density10_real%field%rho, HF_Gamma_Diff, 1)

			ProjectedVBB_local = ProjectedVBB_local + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVBB_local = ProjectedVBB_local + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			! Brink-Boeker exchange term
			CALL SymVBBph_get_ExchangeGamma(HF_Gamma_Diff, diagonal%consistency%vBBph, &
			                                               density10_real%field%rho, 1, 1, ProjectionOn)

			P(1) = SymHartreeFockFieldProj_product_iso(density10_real%field%rho, HF_Gamma_Diff, 1)

			ProjectedVBB_exch = ProjectedVBB_exch + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVBB_exch = ProjectedVBB_exch + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			! Coulomb direct term
			CALL SymVCph_get_LocalGamma(HF_Gamma_Diff, diagonal%consistency%vCph, &
			                                           density10_real%field%rho, 1, 1, ProjectionOn)

			P(1) = SymHartreeFockFieldProj_product_iso(density10_real%field%rho, HF_Gamma_Diff, 1)

			ProjectedVC_local = ProjectedVC_local + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVC_local = ProjectedVC_local + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			! Coulomb exchange term
			CALL SymVCph_get_ExchangeGamma(HF_Gamma_Diff, diagonal%consistency%vCph, &
			                                              density10_real%field%rho, 1, 1, ProjectionOn)

			P(1) = SymHartreeFockFieldProj_product_iso(density10_real%field%rho, HF_Gamma_Diff, 1)

			ProjectedVC_exch = ProjectedVC_exch + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVC_exch = ProjectedVC_exch + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			! Spin-orbit term
			CALL SymVLSph_get_Gamma(HF_Gamma_Diff, diagonal%consistency%vLSph, &
			                                       density10_real%field%rho, 1, 1, ProjectionOn)

			P(1) = SymHartreeFockFieldProj_product_iso(density10_real%field%rho, HF_Gamma_Diff, 1)

			ProjectedVLS = ProjectedVLS + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVLS = ProjectedVLS + 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			!density01 = diagonal%consistency%density
                        ...
                        ! Center of Mass Pairing
                        CALL SymKineticEnergy2Body_get_Delta(HF_Delta, diagonal%consistency%vEkCMpp, &
			                                               density10_real%field%kap, 1, 1, ProjectionOn)

			P(1) = SymHartreeFockFieldProj_product_iso(density01_real%field%kap, HF_Delta, 1)

			ProjectedEkCM_Pair = ProjectedEkCM_Pair - ( 0.5d0/A ) * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)

                        CALL SymKineticEnergy2Body_get_Delta(HF_Delta, diagonal%consistency%vEkCMpp, &
			                                               density10_imag%field%kap, 1, 1, ProjectionOn)
			...
			ProjectedEkCM_Pair = ProjectedEkCM_Pair - ( 0.5d0/A ) * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			ProjectedVBB_Pair = ProjectedVBB_Pair - 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVBB_Pair = ProjectedVBB_Pair - 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			ProjectedVC_Pair = ProjectedVC_Pair - 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVC_Pair = ProjectedVC_Pair - 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
			...
			ProjectedVLS_Pair = ProjectedVLS_Pair - 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(P(1), 0)
			...
			ProjectedVLS_Pair = ProjectedVLS_Pair - 0.5d0 * CoeffsXY%y_l(1)%index(IndexGauge) * CMPLX(0.0d0, P(1))
		...
		DO ta = 0, 1
			...
			DO aa = 0, 2*Lmax
				...
				trace = 0.0
				DO u1 = 1, d
					trace = trace + genden_proj_real%rho%rho(ta, aa)%store(u1, u1) &
					              + genden_proj_imag%rho%rho(ta, aa)%store(u1, u1)*CMPLX(0.0d0, 1.0d0)
				END DO
					...
					DO ipoint = 1, Npoint
						...
						DO mm = 1, d
							...
							DO nn = 1, d
								...
								DensityRadial(ta, ipoint) = DensityRadial(ta, ipoint) &
										+ (ja + 1.0) &
										* genden_proj_real%rho%rho(ta, aa)%store(mm, nn) &
										* WaveFun(ipoint,IndexBasis) &
										* WaveFun(ipoint,IndexKet)
...
END MODULE gauss
 MODULE global
	...
	DOUBLE PRECISION, DIMENSION(0:1), PARAMETER :: m = (0.0241118636155835939, 0.0241118636155835939)
	...
	! GOGNYF = DSA1
	DATA Gogny_W / -1720.30,  103.64, -402.40, -21.30, -402.40, -21.30 /
	DATA Gogny_B /  1300.00, -163.48, -100.00, -11.77, -100.00, -11.77 /
	DATA Gogny_H / -1813.53,  162.81, -496.20,  37.27, -496.20,  37.27 /
	DATA Gogny_M /  1397.60, -223.93,  -23.56, -68.81,  -23.56, -68.81 /
...
!		CALL LogSemiFactorials_new(max_2)
	...
	CONTAINS
		...
		SUBROUTINE InitializeMesh()
			...
			Npoint = 201
			Rbox = 20.0
			MeshStep = Rbox / REAL(Npoint - 1)

			ALLOCATE(RadMesh(0:Npoint))

			DO i = 0, Npoint
				RadMesh(i) = REAL(i)*MeshStep
			END DO
...
#else
		DOUBLE PRECISION :: x_neutron, x_proton, BesselFunc
		DOUBLE PRECISION :: rk, rip, rkp, pi, Order, r1, r2
#endif
		DOUBLE PRECISION :: templateNumber
		...
		DO k = 0, Norder
			...
			DO i_r1 = 1, Npoint
				...
				DO i_r2 = 1, Npoint
					...
					x_neutron = 2.0d0*r1*r2/(1.2**2)
					CALL bessel(x_neutron, Order, BesselFunc, rk, rip, rkp)

					BesselTableNeutron(i_r1,i_r2,k) = BesselFunc * EXP(-(r1**2+r2**2)/(1.2d0**2)) * SQRT(0.5d0*pi/(x_neutron+1.d-14))

					x_proton = 2.0d0*r1*r2/(0.7**2)
					CALL bessel(x_proton, Order, BesselFunc, rk, rip, rkp)

					BesselTableProton(i_r1,i_r2,k)  = BesselFunc * EXP(-(r1**2+r2**2)/(0.7d0**2)) * SQRT(0.5d0*pi/(x_proton+1.d-14))

					IF (ABS(BesselTableNeutron(i_r1,i_r2,k)) .GT. HUGE(templateNumber) .OR. &
					    ABS(BesselTableNeutron(i_r1,i_r2,k)) .LT. TINY(templateNumber)) THEN
						icount = icount + 1
					END IF
	...
	CONTAINS
		...
		FUNCTION nabla2HO(na, nc, la)
			...
			ELSE IF (na .eq. nc) THEN
				nabla2HO = ((na * 2.0d0) + la + 1.5d0) /b_0**2
			ELSE
				nabla2HO = 0.0d0
			END IF
		...
		FUNCTION r2_cutonHO(na, nc, la)
			...
			ELSE IF (na .eq. nc) THEN
				r2_cutonHO = ((na * 2.0d0) + la + 1.5d0 ) *(b_0**2)
			ELSE
				r2_cutonHO = 0.0d0
			END IF
	...
	FUNCTION IntegralA(IndexBra, IndexKet, lb)
		...
		DO Ipoint = 1, Npoint
			  Integrand(Ipoint) = WaveFun(Ipoint,IndexBra)*WaveDeri(Ipoint,IndexKet) - &
		 	          (lb + 1.0d0)* WaveFun(Ipoint,IndexBra)*WaveFun(Ipoint,IndexKet)/RadMesh(Ipoint)
		END DO
...
! Input parameters module
 MODULE input
	...
	INTEGER :: CompHO = 1			! 1 = compatibility with the HO basis in terms of quantum numbers
						! 0 = Lmax and Nmax required

	INTEGER :: Nsize = 2, Npoint, Lmax, Nmax, Isospin = 1
        INTEGER :: IsoFacPair = 2, IsoShiftLambda = 2 ! IsoFacPair: multiplies pairing fields for protons (0), neutrons (1) or both (2)
                                                      ! IsoShiftLambda: shift particle number condition for p (0), n(1) or both (2)

        DOUBLE PRECISION :: Ecut = -1.0, Convergence = 1.e-3, anneal = 0.5
        DOUBLE PRECISION :: facPair = 1.0, ShiftLambda = 0.0, RadPoles = 1.0

	INTEGER :: Nlevel(1:2), Nunity = 20, IndexWave = 1, HFOnly=0, Optimization = 0, NITER_MAX = 10
 ...
 CONTAINS
	...
	SUBROUTINE Input_read
		...
		WRITE(6,'("Oscillator Length (b_0) ........: ",F8.5)') b_0
		...
		SELECT CASE (Gogny)
			CASE (1)
				WRITE(6,'("Parameters of the Gogny force ..: D1S")')
			CASE (2)
				WRITE(6,'("Parameters of the Gogny force ..: D1")')
			CASE (3)
				WRITE(6,'("Parameters of the Gogny force ..: D1p")')
			CASE DEFAULT
...
!---------------------------------------------------------------------!
 ...
 CONTAINS
	...
	SUBROUTINE simps(functi,npoint,step,res)
		...
		res = res + step*(functi(nbegin) + 4.0*functi(nbegin+1) + functi(npoint))/3.0d0
		nbegin = nbegin+2
	...
	FUNCTION CUAD2(la, lb, k)
		...
		CUAD2 = (la * (la + 1.0)) + (lb * (lb + 1.0)) - (k * (k + 1.0d0))
		RETURN
	END FUNCTION CUAD2
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		SelfConsistencyMethodProj_get_EkCM = 0.0 * (HF_Gamma * consistency%density%field%rho)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		SelfConsistencyMethodProj_get_LocalCoulombEnergy = 0.0
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		SelfConsistencyMethodProj_get_ExchangeCoulombEnergy = 0.0
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                SelfConsistencyMethodProj_get_DDEnergy = 0.0
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	FUNCTION SelfConsistencyMethodProj_get_EkPairing(consistency)
		...
		IF (HFOnly .EQ. 0) THEN
			SelfConsistencyMethodProj_get_EkPairing = (0.5/A) * (consistency%density%field%kap * delta)
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
			SelfConsistencyMethodProj_get_EkPairing = 0.0
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		ELSE
			SelfConsistencyMethodProj_get_EkPairing = 0.0
		END IF
	...
	SUBROUTINE SymGenDensityProj_new_SymDensity(genden, density)
		...
		DO ta = 0, 1
			DO la = 0, Lmax
				...
				IF (HFOnly .EQ. 1) genden%kap%rho(ta, 2 * la)%store = 0.1
				...
				IF (HFOnly .EQ. 1) genden%kap%rho(ta, (2 * la) - 1)%store = 0.1
...
! matrices simetricas. Nota: el operador "()" corrige el error
							...
							DO nb = 1, nbmax
								DO nd = 1, nb
									...
									CALL SymD3Tensor_SymD3Tensor_assign(vEkCMpp%v11_pair, la, na, nc, lb, nb, nd, 0.5 * d1)
									CALL SymD3Tensor_SymD3Tensor_assign(vEkCMpp%v11_pair, lb, nb, nd, la, na, nc, 0.5 * d1)
	...
	SUBROUTINE SymKineticEnergy2Body_get_Gamma(HF_out, vEkCMph, HF_in, ta, tb, ProjectionOn)
		...
		IF (ProjectionOn .EQ. 1) THEN
			...
			ELSE
				HF_out%p(tb) = DBLE(0.0)
				HF_out%a(tb) = DBLE(0.0)
			END IF
 ...
 CONTAINS
	...
	SUBROUTINE SymVCph_get_Gamma(HF_out, vCph, HF_in, ta, tb, ProjectionOn)
		...
		IF (ta .EQ. 0) THEN
			...
			ELSE
				HF_out%p(ta) = DBLE(0.0)
				HF_out%a(ta) = DBLE(0.0)
			END IF
		ELSE
			HF_out%p(ta) = DBLE(0.0)
			HF_out%a(ta) = DBLE(0.0)
 ...
 CONTAINS
	...
	SUBROUTINE SymVLSph_get_Gamma(HF_out, vLSph, HF_in, ta, tb, ProjectionOn)
		...
		IF (ProjectionOn .EQ. 1) THEN
			...
			IF (ta .EQ. tb) THEN
				CALL SymD3Tensor_product(tmp3, (1.0 + x0), HF_in%a(ta))
			ELSE
				CALL SymD3Tensor_product(tmp3, x0, HF_in%a(ta))
			END IF
			...
			IF (ta .EQ. tb) THEN
				CALL SymD3Tensor_product(tmp3, (1.0 + x0), HF_in%p(ta))
			ELSE
				CALL SymD3Tensor_product(tmp3, x0, HF_in%p(ta))
			END IF
		...
		ELSE
			...
			CALL SymD3Tensor_product(tmp1, (1.0 + x0), HF_in%a(ta))
			CALL SymD3Tensor_product(tmp2, x0, HF_in%a(1-ta))
			CALL SymD3Tensor_add(tmp3, tmp1, tmp2)

			CALL SymD3Tensor_SymD3Tensor_product(tmp1, vLSph%v12, tmp3)
			CALL SymD3Tensor_product(HF_out%p(tb), factor, tmp1)

			CALL SymD3Tensor_product(tmp1, (1.0 + x0), HF_in%p(ta))
			CALL SymD3Tensor_product(tmp2, x0, HF_in%p(1-ta))
			CALL SymD3Tensor_add(tmp3, tmp1, tmp2)
