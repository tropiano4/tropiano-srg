 ...
 CONTAINS
	...
	SUBROUTINE SymVLSph_get_Gamma(HF_out, vLSph, HF_in, ta, tb, ProjectionOn)
		...
		IF (ProjectionOn .EQ. 1) THEN
			...
			IF (ta .EQ. tb) THEN
				CALL SymD3Tensor_product(tmp3, (1.0D0 + x0), HF_in%a(ta))
			ELSE
			...
			IF (ta .EQ. tb) THEN
				CALL SymD3Tensor_product(tmp3, (1.0D0 + x0), HF_in%p(ta))
			ELSE
		...
		ELSE
			...
			CALL SymD3Tensor_product(tmp1, (1.0D0 + x0), HF_in%a(ta))
			...
			CALL SymD3Tensor_product(tmp1, (1.0D0 + x0), HF_in%p(ta))
