			...
			DO ta = 0, 1
				DO la = 0, Lmax
					...
					genden%rho%rho(ta, 2 * la)%store = &
						(SymD3Tensor_matrix_1(density%field%rho%p(ta), la) * DBLE(2.0 * la) * &
						 SymD3Tensor_matrix_1(density%field%rho%a(ta), la)) / lla

					genden%kap%rho(ta, 2 * la)%store = &
						(SymD3Tensor_matrix_1(density%field%kap%p(ta), la) * DBLE(2.0 * la) * &
					...
					genden%rho%rho(ta, (2 * la) - 1)%store = &
						(SymD3Tensor_matrix_1(density%field%rho%p(ta), la) * DBLE(2.0 * (la + 1)) * &
						 SymD3Tensor_matrix_1(density%field%rho%a(ta), la)) / lla

					genden%kap%rho(ta, (2 * la) - 1)%store = &
						(SymD3Tensor_matrix_1(density%field%kap%p(ta), la) * DBLE(2.0 * (la + 1)) * &
						 SymD3Tensor_matrix_1(density%field%kap%a(ta), la)) / lla
