 MODULE global
	...
	!DATA m / 0.024111868D0, 0.024111868D0 / ! HFODD
	!DATA m / 0.02411499999782965D0, 0.02411499999782965D0 / ! HFODD
	!DATA m / 0.02411397654279172233D0, 0.02411397654279172233D0 / ! Robledo
	!DATA m / 0.0241150000001557829D0, 0.0241150000001557829D0 / ! Robledo
	DATA m / 0.02411186799999999658D0, 0.02411186799999999658D0 / ! Rodrigo/HFBTHO
 ...
 CONTAINS
	...
	SUBROUTINE Global_new
		...
		WRITE(*,'(5X,"=============================",/)')
		WRITE(*,'("Protons : W = ",F9.3," MeV")') Gogny_W(1, Gogny)
		WRITE(*,'("        : B = ",F9.3," MeV")') Gogny_B(1, Gogny)
		WRITE(*,'("        : H = ",F9.3," MeV")') Gogny_H(1, Gogny)
		WRITE(*,'("        : M = ",F9.3," MeV",/)') Gogny_M(1, Gogny)
		WRITE(*,'("Neutrons: W = ",F9.3," MeV")') Gogny_W(0, Gogny)
		WRITE(*,'("        : B = ",F9.3," MeV")') Gogny_B(0, Gogny)
		WRITE(*,'("        : H = ",F9.3," MeV")') Gogny_H(0, Gogny)
		WRITE(*,'("        : M = ",F9.3," MeV",/)') Gogny_M(0, Gogny)
		WRITE(*,'("WLS     : ",F9.3," MeV.fm5")') Gogny_W0(Gogny)
		WRITE(*,'("t_0     : ",F9.3," MeV.fm4",/)') Gogny_t0(Gogny)
		WRITE(*,'("h2/2m   : ",2F20.14," MeV",/)') 0.5D0/m(0),0.5D0/m(1)
