...
! matrices simetricas. Nota: el operador "()" corrige el error
							...
							DO nb = 1, nbmax
								DO nd = 1, nb
									...
									CALL SymD3Tensor_SymD3Tensor_assign(vEkCMpp%v11_pair, la, na, nc, lb, nb, nd, 0.5 * d1*CMPLX(1,0))
									CALL SymD3Tensor_SymD3Tensor_assign(vEkCMpp%v11_pair, lb, nb, nd, la, na, nc, 0.5 * d1*CMPLX(1,0))
									CALL SymD3Tensor_SymD3Tensor_assign(vEkCMpp%v22_pair, la, na, nc, lb, nb, nd, cuad * d1*CMPLX(1,0))
									CALL SymD3Tensor_SymD3Tensor_assign(vEkCMpp%v22_pair, lb, nb, nd, la, na, nc, cuad * d1*CMPLX(1,0))
