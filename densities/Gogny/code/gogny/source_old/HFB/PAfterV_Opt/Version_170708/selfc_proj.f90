 ...
 CONTAINS
	...
	FUNCTION SelfConsistencyMethodProj_get_EkPairing(consistency)
		...
		IF (HFOnly .EQ. 0) THEN
			SelfConsistencyMethodProj_get_EkPairing = (0.5/A) * facPair * (consistency%density%field%kap * delta)
		ELSE
	...
	FUNCTION SelfConsistencyMethodProj_get_BBPairing(consistency)
		...
		IF (HFOnly .EQ. 0) THEN
			SelfConsistencyMethodProj_get_BBPairing = 0.5 * facPair * (consistency%density%field%kap * delta)
		ELSE
	...
	FUNCTION SelfConsistencyMethodProj_get_CoulombPairing(consistency)
		...
		IF (HFOnly .EQ. 0) THEN
			SelfConsistencyMethodProj_get_CoulombPairing = 0.5 * facPair * (consistency%density%field%kap * delta)
		ELSE
	...
	FUNCTION SelfConsistencyMethodProj_get_LSPairing(consistency)
		...
		IF (HFOnly .EQ. 0) THEN
			SelfConsistencyMethodProj_get_LSPairing = 0.5 * facPair * (consistency%density%field%kap * delta)
		ELSE
