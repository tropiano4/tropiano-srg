...
END MODULE constant
 ...
 CONTAINS
	...
	SUBROUTINE DiagonalizationMethod_goto_SelfConsistency(diagonal, tolerance)
		...
		DOUBLE PRECISION :: accuracy, Gauge, factor, ShiftReal
...
END MODULE eigenval
 ...
 CONTAINS
	...
	SUBROUTINE SymGenDensityProj_make_DensityProj(genden_proj_real, genden_proj_imag, CoeffsXY, genden_gauge_real, genden_gauge_imag, UV, nucleus, Factor, NGauge, ta)
...
!------------------------------------------------------------------------------!
 ...
 MODULE symd3t_proj
	...
	IMPLICIT NONE
        ...
        ! SymD2Tensor points to a 2D array or numbers	
	TYPE SymD2Tensor
