...
!TODO yy = function(solve%x(V)) - solve%YY
	...
	SUBROUTINE OneDimSolve_State(solve, L, C, U)
		...
		! ATENCIÓN: Hacemos una doble asignación, por ejemplo: L => I => solve%L
		! debido a que a pesar de que los parámetros de entrada no son
		! "modificables", la llamada a esta función se suele realizar de la
