...
subroutine initialize()
	...
	double precision, dimension(k_magnus) :: factorial_array
	double precision, dimension(k_magnus) :: bernoulli_array
	double precision, dimension(k_magnus) :: magnus_factors
