...
We diagonalize the Hamiltonian for eigenvectors $\phi_{\alpha}$. In the $^{3}S_1$-$^{3}D_1$ coupled channel, the S-component is given by $\phi_{\alpha}[:N]$ and the D-component by $\phi_{\alpha}[N:]$ where $N$ is the length of the momentum mesh. Then the momentum distribution is given by,

\begin{eqnarray}
	\label{eq:momentum_distribution}
	|\phi(k)|^2 = |\phi_{\alpha}[:N]|^2 + |\phi_{\alpha}[N:]|^2.
\end{eqnarray}
...
\textcolor{red}{Add takeaways for these figures.}
