...
%	09/17/19 --- Added more bullets to section 2.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{figure}
%
-- In Fig.~\ref{fig:potential_contours_3S1_Wegner} we consider three different SRG-evolved potentials in the $^3$S$_1$ channel: EM N$^3$LO (500 MeV cutoff) \cite{Entem:2003ft}, RKE N$^3$LO (450 MeV cutoff) \cite{Reinert:2017usi}, and Gezerlis et al. N$^2$LO (1 fm cutoff) \cite{Gezerlis:2014zia}.
%
\begin{figure}[H]
	\centering
	\subfloat[]{%
...
\end{figure}
%
% Ideas for high cutoffs:
%	- Last thing to look at in potentials: cutoff dependence.
%	- Recap Wendt (2011) focusing on universality in matrix elements.
%	- Test block-diagonal evolution for the 3 cutoffs.
%	- Lead into Magnus expansion.
