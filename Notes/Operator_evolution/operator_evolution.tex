...
\begin{figure}[H]
	...
	\caption{$^1$S$_0$ (a), $^3$S$_1$ (b), and $^1$P$_1$ (c) phase shifts for the EM N$^3$LO (solid black), RKE N$^4$LO (red dash-dotted), and Gezerlis \textit{et al.}~N$^2$LO (blue dashed) potentials.}
