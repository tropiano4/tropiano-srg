...
% Question: something you should be ready for, and perhaps add a couple of sentences about in your paper, is how optical potentials are actually used in the analysis of reaction experiments, such as might happen at FRIB
\\
...
% Comment: You go from a potential in (2) that is a function of A+1 nucleons. Where is there a discussion of the decomposition of the potential into two-body, three-body, ... potentials between nucleons? EMAIL DF
...
\end{eqnarray}
%
% Question: be able to derive this below.
...
\end{eqnarray}
% Question: how is this related to nuclear density or probability of finding a nucleon in the nucleus?
%
% Put a couple sentences here explaining Woods-Saxon form factors and parameters. Combine V_C, V and V_SO. Then W paragraph.
...
% Question: it would be useful to have a bit more discussion of (30) and what it implies. E.g., if one could do the integration over P by pulling the density matrix out of the integral with P=0, then we would have the \tau\rho approximation. How does this relate to the phenomenological forms? 
% Question: have an idea of the NCSM.
\\
...
% Question: why are 3NF's important eventually? Why are they difficult to implement (math only).
...
% Question: where did you get the definition of the self-energy as the energy as a result of changes it itself causes in its environment? That is not a definition I would have used.
\\
...
% Question: this may imply questions about the cutoff.
\\
...
\end{figure}
% Question: Looking at Figure 5, you state the characteristics of the contributions resulting from each of the diagrams.  How do I see them? 
...
% If I think of time running upwards, how would you describe the processes depicted in the figures?
% For (a) - we know the antisymmetrized NN interaction includes contact and exchange. See https://journals.aps.org/prc/pdf/10.1103/PhysRevC.88.024614.
%
