...
% Comment: add transition to next section here. Make concluding remarks.
...
% Comment: explain what analyzing powers are.
\\
...
% Comment: what is a one-body density matrix? What is alpha?
\\
...
\\
% Comment: add limitations of method. See motivation on notes.
...
\\
% Comment: references: \cite{King:2018vzw}.

% Summary
%
% Motivation for optical potentials (a couple sentences). Summary of formalism (one sentence). Summary of phenomenological models with recap on limitations. Summary of multiple scattering approach with recap on limitations and successes. Same for nucleon self-energy. Transition sentence to next paragraph about microscopic approaches not listed. Other microscopic approaches: G-matrix interaction, self-consistent Green's function (other Green's function methods), etc. Cite these. 

% Outlook
%
% Key theoretical issues. Getting nuclear radii is important? Too in-precise for experimental use. Microscopic models can help guide phenomenological ones. Lead into uncertainty quantification. 3N forces. See proposal for SRG evolution of optical potentials. Closing sentence.
