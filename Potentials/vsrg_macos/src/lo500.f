...
c
c        Charge-Dependent Chiral NN Potential at Order Zero
c        --------------------------------------------------
c        applying a cutoff of 500 MeV: LO(500).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `lo500' needs to be called by the user.
...
c        choose the np potential as the default:
      ...
      if (j.lt.0) then
      write (kwrite,19002)
19002 format (////' error in lo: total angular momentum j',
...
c
     ...
     *   -0.111564593d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     ...
     8    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *   -0.0826251323d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.113238d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.111564593d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.11194445d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' lo500: Charge-Dependent Chiral NN Potential',
     1/' at Order Zero using Lambda = 500 MeV, LO(500)')
...
c
      ...
      if (ityp.lt.1.or.ityp.gt.6) go to 9002
c
      im=ime
c
...
c
      go to (100,100,300,9002,500,600),ityp
c
c
c
c
...
c
 ...
 6000 go to (100,100,300,9002,500,600),ityp
c
c
c
c
...
c**************** this is the end of the program lo500 ********************
      END MODULE
