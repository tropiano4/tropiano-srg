...
! BEGIN: ADDED by RJF on 08-MAY-2017
...
! END:  ADDED by RJF on 08-MAY-2017

! BEGIN: ADDED by RJF on 30-NOV-2017
!  More kvnn numbers to accommodate 2017 semi-local chiral EFT from Reinert-Krebs-Epelbaum
...
!
      IF (kvnn.eq.16) THEN
        ...
        cutnum = 2  ! default
      ENDIF
      IF ((kvnn.ge.90).and.(kvnn.le.94)) THEN 
        ostat = 0   ! LO
        cutnum = kvnn - 89  ! check in chart above
        write(6,*) "got here!"
        kvnn = 16  ! reset to the number for Epelbaum smschiral_RS potential  
      ENDIF
      IF ((kvnn.ge.95).and.(kvnn.le.99)) THEN 
        ostat = 1   ! NLO
        cutnum = kvnn - 94  ! check in chart above
        kvnn = 16  ! reset to the number for Epelbaum smschiral_RS potential  
      ENDIF
      IF ((kvnn.ge.100).and.(kvnn.le.104)) THEN 
        ostat = 2   ! N2LO
        cutnum = kvnn - 99  ! check in chart above
        kvnn = 16  ! reset to the number for Epelbaum smschiral_RS potential  
      ENDIF
      IF ((kvnn.ge.105).and.(kvnn.le.109)) THEN 
        ostat = 3   ! N3LO
        cutnum = kvnn - 104  ! check in chart above
        kvnn = 16  ! reset to the number for Epelbaum smschiral_RS potential  
      ENDIF
      IF ((kvnn.ge.110).and.(kvnn.le.114)) THEN 
        ostat = 4   ! N4LO
        cutnum = kvnn - 109  ! check in chart above
        kvnn = 16  ! reset to the number for Epelbaum smschiral_RS potential  
      ENDIF
      IF ((kvnn.ge.115).and.(kvnn.le.119)) THEN 
        ostat = 5   ! N4LO+
        cutnum = kvnn - 114  ! check in chart above
        kvnn = 16  ! reset to the number for Epelbaum smschiral_RS potential  
      ENDIF
! END:  ADDED by RJF on 30-NOV-2017
...
! 08-May-2017 Insert new Entem-Machleidt calls here 
        if (kvnn.eq.70) call wrapper_newEM_lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.71) call wrapper_newEM_nlo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.72) call wrapper_newEM_n2lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.73) call wrapper_newEM_n3lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.74) call wrapper_newEM_n4lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.75) call wrapper_newEM_lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.76) call wrapper_newEM_nlo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.77) call wrapper_newEM_n2lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.78) call wrapper_newEM_n3lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.79) call wrapper_newEM_n4lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.80) call wrapper_newEM_lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.81) call wrapper_newEM_nlo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.82) call wrapper_newEM_n2lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.83) call wrapper_newEM_n3lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        if (kvnn.eq.84) call wrapper_newEM_n4lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
        ...
        ! RJF: 30-Nov-2017  Epelbaum 2017 potentials arXiv:1711.08821
        if(kvnn.eq.16)call n4loepelbaum_2017(ostat,cutnum,'np',icoup,ll,is,jt,nkp,xkp,xwkp)
...
! 08-May-2017 Insert new Entem-Machleidt calls here        
     ...
     1   (kvnn.ne.11).and.(kvnn.ne.12).and.(kvnn.ne.13).and.(kvnn.ne.15).and.(kvnn.ne.16)
...
c	if(kvnn.eq.8)call vkknijc(kvnn,itz,jt,nkp,xkp,v)
        ...
        if(kvnn.eq.9)call n3loepelbaum(ostat,cutnum,'np',icoup,ll,is,jt,nkp,xkp,xwkp)
        if(kvnn.eq.15)call n4loepelbaum(ostat,cutnum,'np',icoup,ll,is,jt,nkp,xkp,xwkp)
        ! RJF 30-Nov-2017 added call to n4loepelbaum_2017
        if(kvnn.eq.16)call n4loepelbaum_2017(ostat,cutnum,'np',icoup,ll,is,jt,nkp,xkp,xwkp)
	if(kvnn.eq.3)call reidvkk(ll,is,jt,it,itz,nkp,xkp,xwkp,vnn_kkww)
...
!      if((kvnn.ne.6).and.(kvnn.ne.3).and.(kvnn.ne.9).and.(kvnn.ne.10))
     ...
     1    .and.(kvnn.ne.11).and.(kvnn.ne.12).and.(kvnn.ne.13).and.(kvnn.ne.15).and.(kvnn.ne.16)
     1    .and.((kvnn.lt.70).or.(kvnn.gt.84))                 
     1  )
	...
	allocate(vem_kk(2*nkp,2*nkp))
        vem_kk=0.
! remove temporary commenting of empotkk?       
      !  CALL empotkk(icoup,itz1,itz2,LL,is,jt,it,xkp,xwkp,nkp,vem_kk)
...
c	if(kvnn.eq.8)call vkkniju(kvnn,itz,ll,is,jt,nkp,xkp,v) 
	if(kvnn.eq.3)call reidvkk(ll,is,jt,it,itz,nkp,xkp,xwkp,vnn_kkww) 
      ...
      v=v*hb2m ! MeV-fm**3
      if((kvnn.ne.7).and.(kvnn.ne.6).and.(kvnn.ne.3).and.(kvnn.ne.9).and.(kvnn.ne.10).and.
     1   (kvnn.ne.11).and.(kvnn.ne.15).and.(kvnn.ne.16)
     1      )
     1   call svdivide1(v,nkp,xkp,xwkp,nkp,vnn_kkww,nd1)!v(i)to vbare(i,j)
...
!      if((kvnn.ne.6).and.(kvnn.ne.3).and.(kvnn.ne.9).and.(kvnn.ne.10))
      if((kvnn.ne.7).and.(kvnn.ne.6).and.(kvnn.ne.3).and.(kvnn.ne.9).and.(kvnn.ne.10)
     1    .and.(kvnn.ne.11).and.(kvnn.ne.15).and.(kvnn.ne.16)
     1    )
     1 call svdivide2(v,2*nkp,xkp,xwkp,nkp,vnn_kkww,nd1)
...
!************* BEGIN: New Entem-Machleidt potentials May 8, 2017

      subroutine wrapper_newEM_lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                call POT_newEM_lo450_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
        ...
        return
        end subroutine wrapper_newEM_lo450

      SUBROUTINE POT_newEM_lo450_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_lo450
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_lo450_LSJ


      subroutine wrapper_newEM_nlo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_nlo450_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_nlo450

      SUBROUTINE POT_newEM_nlo450_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_nlo450
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_nlo450_LSJ

      subroutine wrapper_newEM_n2lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n2lo450_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n2lo450

      SUBROUTINE POT_newEM_n2lo450_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n2lo450
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n2lo450_LSJ

      subroutine wrapper_newEM_n3lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n3lo450_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n3lo450

      SUBROUTINE POT_newEM_n3lo450_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n3lo450new
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
      INTEGER FORCE
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n3lo450_LSJ

      subroutine wrapper_newEM_n4lo450(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n4lo450_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n4lo450

      SUBROUTINE POT_newEM_n4lo450_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n4lo450
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n4lo450_LSJ


      subroutine wrapper_newEM_lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_lo500_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_lo500

      SUBROUTINE POT_newEM_lo500_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_lo500
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_lo500_LSJ

      subroutine wrapper_newEM_nlo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_nlo500_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_nlo500

      SUBROUTINE POT_newEM_nlo500_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_nlo500
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_nlo500_LSJ

      subroutine wrapper_newEM_n2lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n2lo500_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n2lo500

      SUBROUTINE POT_newEM_n2lo500_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n2lo500
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n2lo500_LSJ

      subroutine wrapper_newEM_n3lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n3lo500_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n3lo500

      SUBROUTINE POT_newEM_n3lo500_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n3lo500new
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
      INTEGER FORCE
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n3lo500_LSJ

      subroutine wrapper_newEM_n4lo500(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n4lo500_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n4lo500

      SUBROUTINE POT_newEM_n4lo500_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n4lo500
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n4lo500_LSJ


      subroutine wrapper_newEM_lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_lo550_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_lo550

      SUBROUTINE POT_newEM_lo550_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_lo550
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_lo550_LSJ

      subroutine wrapper_newEM_nlo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_nlo550_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_nlo550

      SUBROUTINE POT_newEM_nlo550_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_nlo550
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_nlo550_LSJ

      subroutine wrapper_newEM_n2lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n2lo550_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n2lo550

      SUBROUTINE POT_newEM_n2lo550_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n2lo550
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n2lo550_LSJ

      subroutine wrapper_newEM_n3lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n3lo550_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n3lo550

      SUBROUTINE POT_newEM_n3lo550_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n3lo550new
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
      INTEGER FORCE
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n3lo550_LSJ

      subroutine wrapper_newEM_n4lo550(icoup,it,itz,ll,is,jt,nkp,xkp,xwkp) 
      implicit real*8(a-h,o-z)      
      real*8::xkp(:),xwkp(:)
      logical icoup
      integer::force
      ...
      if(.not.icoup)then
          do i=1,nkp
                ...
                y=xkp(ii)
                xkkww=sqrt(xwkp(i)*xwkp(ii))*hb2m
                call POT_newEM_n4lo550_LSJ(X,Y,LL,IS,JT,V00,V02,V20,V22,ICOUP,FORCE)        
                vnn_kkww(i,ii)=v00*xkkww 
                enddo
                enddo
      else if(icoup)then
        ...
        return
        end subroutine wrapper_newEM_n4lo550

      SUBROUTINE POT_newEM_n4lo550_LSJ(X,Y,L,IS,JJ,V00,V02,V20,V22,TENSOR,FORCE)
      USE newEM_n4lo550
      implicit real*8(a-h,o-z)
C     =================
                          ! 1...PP,  2...NP, 3...NN   !KMD
...
C
 ...
 4    V00 = V(4)*FF
      ...
      V20 = -V(5)*FF
      RETURN
      END SUBROUTINE POT_newEM_n4lo550_LSJ
...
!     3P0                                                               
  ...
  100 continue 
      ...
      END SUBROUTINE potchirallsj                                          
        ...
        subroutine n4loepelbaum_2017(ostat,cutnum,force,coupled,ll,is,jt,nkp,xkp,xwkp)
        ! rjf: use the epelbaum 2017 potentials
        implicit real*8(a-h,o-z)
        integer::ll,is,jt,nkp,cutnum,ostat
        character*2 force
        real*8::xkp(:),xwkp(:)
        ...
        p=xkp(i)
        ps=xkp(j)
        call potchiral4lsj_2017(p,ps,ll,is,jt,v00,v02,v20,v22,coupled,ostat,cutnum,force)
        vnn_kkww(i,j)=v00*sqrt(xwkp(i)*xwkp(j))*hb2m !41.47
        enddo
        enddo
        else if(coupled)then
...
c--------------------------------------------------------------------
      subroutine potchiral4lsj_2017(p,ps,l,is,jmom,v00,v02,v20,v22,koup,ostat,cutnum,force)
! use the new 2017 potentials (USE SMSCHIRAL below)     
!      USE PARAMETERS
!                                                                       
...
!     3P0                                                               
  ...
  100 continue 
      ...
      v22=potent(6)*FACTOR 
      return 
      END SUBROUTINE potchiral4lsj_2017                                          
...
c --------------------
 ...
 2000 continue
	...
	ipwv=1;if((kvnn.eq.9).OR.(kvnn.eq.15).OR.(kvnn.eq.16)) ipwv=0  ! RJF: 30-Nov-2017 kvnn=16
      tz=(tz1+tz2)/2
