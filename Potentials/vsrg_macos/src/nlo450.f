...
c        --------------------------------------------------
c        applying a cutoff of 450 MeV: NLO(450).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `nlo450' needs to be called by the user.
...
c
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     ...
     7   -0.155504400d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    1.544880859d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    1.158848939d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.370779032d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5   -0.415391064d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.18578856523d0, 0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8   -0.278055239d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.128057184d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.239058357d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.15436000d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.15550440d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.154949850d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' nlo450: Charge-Dependent Chiral NN Potential',
     1/' at Order Two using Lambda = 450 MeV, NLO(450)')
