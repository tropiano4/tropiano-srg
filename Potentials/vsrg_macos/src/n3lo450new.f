         MODULE newEM_n3lo450new
         implicit real*8(a-h,o-z)
         PRIVATE
         PUBLIC :: n3lo450new
         CONTAINS
         subroutine n3lo450new
c
c******************************************************************
c
...
c        --------------------------------------------------
c        applying a cutoff of 450 MeV: N3LO(450) of A.D.2017.
c        ---------------------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n3lo450new' needs to be called by the user.
...
c
     ...
     *   37.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     ...
     6    0.000000000d0,   0.0d0,    2.0000d0,  450.0d0,   0.0d0,
     7   -0.148260070d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8    2.433681676d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9   -1.994401772d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     *  -17.030231473d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     1    1.154243531d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     2    5.058102140d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     3    0.014160390d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     4   11.337758526d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     5   -0.846304327d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     6    4.903722331d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7   -0.1487638807d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8    0.706331009d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9   -6.695551216d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
      data ((tab(i,j),i=1,5),j=100,122)/
     *  -14.382027321d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     1   -5.698103525d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     2    0.478194099d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     3    0.314046356d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     4    2.605874012d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     5   -2.001966897d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     6   -3.525233090d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7   -0.752384088d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8    5.794838454d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9    0.019145921d0,   4.0d0,  450.0000d0,    0.0d0,   0.0d0,
     *   -1.544911604d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.14660321102d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.14826007d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.147518666d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' n3lo450new: Charge-Dependent Chiral NN Potential',
     1/' at Order Four using Lambda = 450 MeV, N3LO(450) of A.D.2017')
...
c**************** this is the end of the program n3lo450new ********************
      END MODULE
