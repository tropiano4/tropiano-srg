...
# This assumes the vector is 3 dimensional on the zeroth axis!
# e.g., vector = < x array_like, y array_like, z array_like >
...
# NOTE: This seems general enough. You can sub in psi * (-1) ** l
