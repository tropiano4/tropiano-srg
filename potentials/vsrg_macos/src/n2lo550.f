...
c        --------------------------------------------------
c        applying a cutoff of 550 MeV: N2LO(550).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n2lo550' needs to be called by the user.
...
c
     ...
     *    6.000000000d0,   0.0d0,    2.0000d0,  550.0d0,   0.0d0,
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     ...
     5    0.000000000d0,   0.0d0,    2.0000d0,  550.0d0,   0.0d0,
     6   -0.149750230d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     7    2.305300415d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     *    1.093309042d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     2    0.195708324d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     4   -0.826633824d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     6   -0.13616975754d0, 3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     7    0.381155567d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     1    0.319424664d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     6   -0.624552590d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     7    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.14906705d0,  3.0d0,  550.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.14975023d0,  3.0d0,  550.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.14945923d0,  3.0d0,  550.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' n2lo550: Charge-Dependent Chiral NN Potential',
     1/' at Order Three using Lambda = 550 MeV, N2LO(550)')
