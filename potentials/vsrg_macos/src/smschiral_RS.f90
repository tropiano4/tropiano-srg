...
! Changes made here by AT: Set CUTQ(0) to correspond to cutoffs of 3.0,4.0,9.0, etc fm^-1
! Original value of CUTQ(0) = 0.4 GeV
! and changed CLO(2,1) (units 10^4 GeV^-2) such that LO potential gives the binding
! energy of deuteron = -2.2245 MeV
! Original value of C^~_3S1 = -0.10963014D+00
! Lambda = 1.0 fm^-1 -> CUTQ(0) = 0.19732697 GeV and CLO(2,1) = -0.355907
! Lambda = 2.0 fm^-1 -> CUTQ(0) = 0.39465394 GeV and CLO(2,1) = -0.113315
! Lambda = 3.0 fm^-1 -> CUTQ(0) = 0.59198091 GeV and CLO(2,1) = -0.032149
! Lambda = 4.0 fm^-1 -> CUTQ(0) = 0.78930788 GeV and CLO(2,1) = 0.0389465
! Lambda = 5.0 fm^-1 -> CUTQ(0) = 0.98663485 GeV and CLO(2,1) = 0.223448
! Lambda = 6.0 fm^-1 -> CUTQ(0) = 1.18396182 GeV and CLO(2,1) = -0.435835
! Lambda = 7.0 fm^-1 -> CUTQ(0) = 1.38128879 GeV and CLO(2,1) = -0.123585
! Lambda = 8.0 fm^-1 -> CUTQ(0) = 1.57861576 GeV and CLO(2,1) = -0.0619595
! Lambda = 9.0 fm^-1 -> CUTQ(0) = 1.77594273 GeV and CLO(2,1) = -0.0285304
! Lambda = 10.0 fm^-1 -> CUTQ(0) = 1.9732697 GeV and CLO(2,1) = -0.0019387
! Lambda = 11.0 fm^-1 -> CUTQ(0) = 2.17059667 GeV and CLO(2,1) = 0.026589
! Lambda = 12.0 fm^-1 -> CUTQ(0) = 2.36792364 GeV and CLO(2,1) = 0.070616
! Lambda = 13.0 fm^-1 -> CUTQ(0) = 2.56525061 GeV and CLO(2,1) = 0.204715
! Lambda = 14.0 fm^-1 -> CUTQ(0) = 2.76257758 GeV and CLO(2,1) = -0.64065
! Lambda = 15.0 fm^-1 -> CUTQ(0) = 2.95990455 GeV and CLO(2,1) = -0.131065
! Lambda = 16.0 fm^-1: -> CUTQ(0) = 3.15723152 GeV and CLO(2,1) = -0.068034
! Lambda = 17.0 fm^-1: -> CUTQ(0) = 3.35455849 GeV and CLO(2,1) = -0.0405675
! Lambda = 18.0 fm^-1: -> CUTQ(0) = 3.55188546 GeV and CLO(2,1) = -0.0236185
! Lambda = 19.0 fm^-1: -> CUTQ(0) = 3.74921243 GeV and CLO(2,1) = -0.01104
! Lambda = 20.0 fm^-1: -> CUTQ(0) = 3.9465394 GeV and CLO(2,1) = -0.0004695
!==================================================================================================
 DATA            CLO    /&                                                                       !=
