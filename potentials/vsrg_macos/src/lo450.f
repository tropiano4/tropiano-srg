...
c        --------------------------------------------------
c        applying a cutoff of 450 MeV: LO(450).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `lo450' needs to be called by the user.
...
c
     ...
     *   -0.116531100d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     ...
     8    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *   -0.101616328d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.118157d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.11653110d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.11683640d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' lo450: Charge-Dependent Chiral NN Potential',
     1/' at Order Zero using Lambda = 450 MeV, LO(450)')
...
c**************** this is the end of the program lo450 ********************
      END MODULE
