         MODULE newEM_n3lo550new
         implicit real*8(a-h,o-z)
         PRIVATE
         PUBLIC :: n3lo550new
         CONTAINS
         subroutine n3lo550new
c
c******************************************************************
c
...
c        --------------------------------------------------
c        applying a cutoff of 550 MeV: N3LO(550) of A.D.2017.
c        ---------------------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n3lo550new' needs to be called by the user.
...
c
     ...
     *   37.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     ...
     6    0.000000000d0,   0.0d0,    2.0000d0,  550.0d0,   0.0d0,
     7   -0.141335800d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     8    2.443079949d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     9   -3.309647440d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     *  -15.017889830d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     1    1.216246291d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     2    5.179208870d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     3    0.196556780d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     4    9.872407135d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     5   -0.776363355d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     6    4.818031644d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     7   -0.1493143576d0,  3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     8    0.803224493d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     9   -4.268259866d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0/
c
      data ((tab(i,j),i=1,5),j=100,122)/
     *  -19.180690796d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     1   -5.406178465d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     2    0.496529848d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     3    1.307412796d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     4    1.370719055d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     5   -1.936755837d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     6   -3.148938770d0,   3.0d0,  550.0000d0,    0.0d0,   0.0d0,
     7   -0.766556752d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     8    6.200585745d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
     9    0.028030232d0,   4.0d0,  550.0000d0,    0.0d0,   0.0d0,
     *   -1.133446237d0,   2.0d0,  550.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.1395984205d0,  3.0d0,  550.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.14133580d0,  3.0d0,  550.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.1404357d0,  3.0d0,  550.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' n3lo550new: Charge-Dependent Chiral NN Potential',
     1/' at Order Four using Lambda = 550 MeV, N3LO(550) of A.D.2017')
...
c**************** this is the end of the program n3lo550new ********************
      END MODULE
