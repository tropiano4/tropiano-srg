...
c
c        Charge-Dependent Chiral NN Potential at Order Two
c        --------------------------------------------------
c        applying a cutoff of 500 MeV: NLO(500).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `nlo500' needs to be called by the user.
...
c        choose the np potential as the default:
      ...
      if (j.lt.0) then
      write (kwrite,19002)
19002 format (////' error in nlo: total angular momentum j',
...
c
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     1   13.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,
     3   14.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4   -1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,
     5   11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6   14.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.151103420d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    1.600626575d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    1.185093243d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.386001255d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5   -0.440417744d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.1769381148d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8   -0.267697877d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.139229600d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.212062070d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.14965902d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.15110342d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.150430267d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
...
10008 format (1h ,45(1h-))
10009 format (2a4,a2,i3,2f10.2)
10010 format (1h ,2a4,a2,i3,2f10.2)
10011 format (//' nlo500: Charge-Dependent Chiral NN Potential',
     1/' at Order Two using Lambda = 500 MeV, NLO(500)')
...
c
      ...
      if (ityp.lt.1.or.ityp.gt.14) go to 9002
c
      im=ime
c
...
c**************** this is the end of the program nlo500 ********************
      END MODULE
