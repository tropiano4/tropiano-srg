...
c        --------------------------------------------------
c        applying a cutoff of 550 MeV: NLO(550).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `nlo550' needs to be called by the user.
...
c
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     ...
     7   -0.133829790d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    1.741652609d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    1.233330555d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.303819445d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5   -0.487744567d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.16223662507d0, 0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8   -0.244472751d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.140213623d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     6    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     7   -0.190333309d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.13152544454d0,0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.13382979d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.132762400d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' nlo550: Charge-Dependent Chiral NN Potential',
     1/' at Order Two using Lambda = 550 MeV, NLO(550)')
...
c**************** this is the end of the program nlo550 ********************
      END MODULE
