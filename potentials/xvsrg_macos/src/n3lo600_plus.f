...
c        --------------------------------------------------
c        in momentum space.
c        A cutoff of Lambda = 600 MeV is applied.
c        This model is sometimes referred to as N3LO(600).
c        ------------------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n3lo600' needs to be called by the user.
...
c        choose the np potential as the default:
      ...
      if (j.lt.0) then
      write (kwrite,19002)
19002 format (////' error in n3lo600: total angular momentum j',
...
c
      data tab/
     1    6.000000d0,   0.0d0,    4.0000d0,  600.0d0,   0.0d0,
     ...
     *    0.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    6.000000d0,   0.0d0,    2.0000d0,  600.0d0,   0.0d0,
     ...
     *   55.000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     ...
     6    0.000000d0,   0.0d0,    2.0000d0,  600.0d0,   0.0d0,
     7   -0.151745d0,   3.0d0,  600.0000d0,    0.0d0,   0.0d0,
     8    2.200000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     9   -4.890000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     *   -5.840000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     1    1.548000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     2   -0.215000d0,   3.0d0,  600.0000d0,    0.0d0,   0.0d0,
     3    0.790000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     4    4.400000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     5   -0.488000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     6    3.240000d0,   4.0d0,  600.0000d0,    0.0d0,   0.0d0,
!     7   -0.000000000d0,3.0d0,  600.0000d0,    0.0d0,   0.0d0,
!     8    0.000000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
!     9    0.000000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
!     *    0.000000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     7   -0.116210000d0,3.0d0,  600.0000d0,    0.0d0,   0.0d0,
     8    0.775000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     9    4.800400d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     *   10.865400d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     1   -2.350000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     2    0.796000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     3    2.860000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     4    5.580000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     5   -1.764000d0,   4.0d0,  600.0000d0,    0.0d0,   0.0d0,
     6   -1.270000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     7   -0.548000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     8    2.554000d0,   2.0d0,  600.0000d0,    0.0d0,   0.0d0,
     9   -0.525000d0,   4.0d0,  600.0000d0,    0.0d0,   0.0d0,
     *    6.260000d0,   2.5d0,  600.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.151165d0,   3.0d0,  600.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.151745d0,   3.0d0,  600.0000d0,    0.0d0,   0.0d0/
...
c
      data t1s0nn/
     7   -0.151467d0,   3.0d0,  600.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' n3lo600: Charge-Dependent Chiral NN Potential',
     1 /' at Order Four using Lambda = 600 MeV, N3LO(600)')
...
c**************** this is the end of the program n3lo600 **********************
      END MODULE
