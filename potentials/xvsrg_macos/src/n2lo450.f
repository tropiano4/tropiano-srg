...
c        --------------------------------------------------
c        applying a cutoff of 450 MeV: N2LO(450).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n2lo450' needs to be called by the user.
...
c
     ...
     *    6.000000000d0,   0.0d0,    2.0000d0,  450.0d0,   0.0d0,
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     ...
     5    0.000000000d0,   0.0d0,    2.0000d0,  450.0d0,   0.0d0,
     6   -0.152694520d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7    2.359346473d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     *    1.074628290d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     2    0.240920389d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     4   -0.822516878d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     6   -0.166923906d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7    0.527883469d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     1    0.402033229d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     6   -0.656520134d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.15185696d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.15269452d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.1523466d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' n2lo450: Charge-Dependent Chiral NN Potential',
     1/' at Order Three using Lambda = 450 MeV, N2LO(450)')
...
c**************** this is the end of the program n2lo450 ********************
      END MODULE
