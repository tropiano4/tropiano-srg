...
c        --------------------------------------------------
c        applying a cutoff of 500 MeV: N4LO(500)
c        ---------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n4lo500' needs to be called by the user.
...
c                     and
c        D. R. Entem, R. Machleidt, and Y. Nosyk, to be published.
c       
c*******************************************************************
c*******************************************************************
c
...
c
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,
     ...
     9    0.000000000d0,   0.0d0,    2.0000d0,  500.0d0,   0.0d0,
     *   -0.142358500d0,   3.0d0,  500.0000d0,    0.0d0,   0.0d0,
     1    2.494633548d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     2   -1.779896956d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     3  -13.385692976d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     4    1.214966189d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     5    4.571860915d0,   3.0d0,  500.0000d0,    0.0d0,   0.0d0,
     6    0.232092261d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     7   10.956500634d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     8   -0.859718490d0,   3.0d0,  500.0000d0,    0.0d0,   0.0d0,
     9    4.133947333d0,   3.0d0,  500.0000d0,    0.0d0,   0.0d0,
     *   -0.151581533d0,   3.0d0,  500.0000d0,    0.0d0,   0.0d0,
     1    0.867156546d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     2   -2.949089421d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     3  -20.793199632d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     4   -6.018265610d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     5    0.550117472d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     6    1.345478412d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     7    2.176852098d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     8   -1.545851484d0,   3.0d0,  500.0000d0,    0.0d0,   0.0d0,
     9   -3.383001593d0,   3.0d0,  500.0000d0,    0.0d0,   0.0d0,
     *   -0.763178505d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     1    5.342485336d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     2    0.076818254d0,   4.0d0,  500.0000d0,    0.0d0,   0.0d0,
     3   -0.664832879d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     4    1.222149783d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     5    1.316452134d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
     ...
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1   -0.321096808d0,   2.0d0,  500.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.1405135d0,  3.0d0,  500.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.1423585d0,  3.0d0,  500.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.1414716d0,  3.0d0,  500.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' n4lo500: Charge-Dependent Chiral NN Potential',
     1/' at Order Five using Lambda = 500 MeV, N4LO(500)')
...
c**************** this is the end of the program n4lo500 ********************
      END MODULE
