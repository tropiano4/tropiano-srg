...
!s      EXTERNAL          CONST, MCONST, RKMSG, RKSIT
...
C     .. External Subroutines ..
!s      EXTERNAL          CHKFL, CT, INTRP, RESET, RKMSG, RKSIT
C     .. Intrinsic Functions ..
...
C     .. Local Scalars ..
     ...
     &                  TOOMCH
C     .. External Subroutines ..
!s      EXTERNAL          RKMSG, RKSIT, STEP, STIFF, TRUERR
C     .. Intrinsic Functions ..
...
C     .. Local Scalars ..
     ...
     &                  STATE1
      ...
      CHARACTER         REQST1
C     .. External Subroutines ..
!s      EXTERNAL          EVALI, FORMI, RKMSG, RKSIT
C     .. Intrinsic Functions ..
      INTRINSIC         MAX
C     .. Save statement ..
...
C     .. External Functions ..
!s      DOUBLE PRECISION  DOTPRD
!s      EXTERNAL          DOTPRD
C     .. External Subroutines ..
!s      EXTERNAL          STIFFB, STIFFC, STIFFD
C     .. Intrinsic Functions ..
