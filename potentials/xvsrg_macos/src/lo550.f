...
c        --------------------------------------------------
c        applying a cutoff of 550 MeV: LO(550).
c        ----------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `lo550' needs to be called by the user.
...
c
     ...
     *   -0.107545040d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     ...
     8    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *   -0.0647485517d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.109215d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.10754504d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.10796868d0,  0.0d0,    0.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' lo550: Charge-Dependent Chiral NN Potential',
     1/' at Order Zero using Lambda = 550 MeV, LO(550)')
