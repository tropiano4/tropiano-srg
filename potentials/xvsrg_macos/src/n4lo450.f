...
c        --------------------------------------------------
c        applying a cutoff of 450 MeV: N4LO(450)
c        ---------------------------------------
c
c        this package is self-contained and includes
c        all subroutines needed.
c        only `n4lo450' needs to be called by the user.
...
c
     ...
     1    6.000000000d0,   0.0d0,    4.0000d0,  450.0d0,   0.0d0,
     ...
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1    6.000000000d0,   0.0d0,    2.0000d0,  450.0d0,   0.0d0,
...
c
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,
     ...
     9    0.000000000d0,   0.0d0,    2.0000d0,  450.0d0,   0.0d0,
     *   -0.147362900d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     1    2.487738016d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     2   -1.150020398d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     3  -14.021946990d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     4    1.186064651d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     5    4.691445850d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     6    0.098890740d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7   12.149802922d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8   -0.886904819d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9    4.313801078d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     *   -0.1501459132d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     1    0.754108328d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     2   -6.381160123d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     3  -13.404946692d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     4   -6.395560369d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     5    0.557930879d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     6    0.429852082d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7    2.641434760d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     8   -1.609085638d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     9   -3.580783224d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,
     *   -0.752727962d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     1    5.082696436d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     2    0.090113718d0,   4.0d0,  450.0000d0,    0.0d0,   0.0d0,
     3   -0.892372983d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     4    0.825320592d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     5    1.634929563d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     6    0.620118203d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
     7    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,
     1   -0.555481025d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.1457557d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.1473629d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.1466365d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
c
c
...
10011 format (//' n4lo450: Charge-Dependent Chiral NN Potential',
     1/' at Order Five using Lambda = 450 MeV, N4LO(450)')
...
c**************** this is the end of the program n4lo450 ********************
      END MODULE
